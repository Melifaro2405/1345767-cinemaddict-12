...
export default class Board {
  ...
  destroy() {
    ...
    this._filmsModel.removeObserver(this._handleFilmChange.bind(this));
    this._filterModel.removeObserver(this._onFilterTypeChange.bind(this));
  }
  ...
  _clearBoard(resetRenderedFilmCount = false) {
